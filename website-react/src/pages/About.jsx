    ...
    <div data-testid="about-page">
      <section className="section" style={{ paddingTop: 140, maxWidth: 800, margin: '0 auto' }}>
        ...
        <h1 className="section-title" style={{ fontSize: 'clamp(32px, 4vw, 52px)', marginBottom: 48 }}>
          Sijill Project<span style={{ color: 'var(--accent)' }}>.</span>
        </h1>
        ...
        <div className="about-body">
          ...
          <p>Sijill Project est un espace où ces héritages sont présentés dans leur complexité, avec le sérieux qu'ils méritent, et avec la conviction qu'ils demeurent essentiels pour penser le monde aujourd'hui.</p>

          <h2>Qui sommes-nous ?</h2>
          <p>Sijill Project est une plateforme académique née d'une conviction : l'histoire intellectuelle du monde islamique constitue l'un des patrimoines les plus riches, les plus pluriels et les plus féconds de l'humanité, mais trop souvent, elle demeure inaccessible, fragmentaire ou déformée.</p>
          ...
          <p>Tous les contenus proposés sur Sijill Project sont conçus ou présentés par des chercheurs, enseignants-chercheurs ou universitaires reconnus dans leur domaine. Nous ne proposons ni vulgarisation approximative, ni discours d'autorité, mais une transmission fondée sur les textes, les manuscrits, les éditions critiques et les travaux académiques contemporains. Chaque capsule, chaque module, chaque cours s'appuie sur les sources primaires et s'inscrit dans l'état actuel de la recherche internationale.</p>
          ...
          <p>Sijill Project se donne pour mission de présenter cet ensemble non comme une juxtaposition hétéroclite, mais comme un tissu intellectuel cohérent dans sa diversité.</p>

          <h3>3. Une contextualisation historique précise</h3>
          <p>Comprendre le kalām sans saisir les débats du VIII<sup>e</sup> siècle ; comprendre Avicenne sans l'important mouvement de traduction du grec ; comprendre Ibn ʿArabī sans la crise des savoirs du XI<sup>e</sup> siècle ; comprendre Mullā Ṣadrā sans la culture safavide — tout cela est impossible. Nos modules replacent chaque œuvre dans son époque, dans son environnement politique, dans sa langue et dans son horizon conceptuel. Retracer les transmissions, les ruptures, les polémiques, les synthèses : telle est la méthode qui oriente nos parcours.</p>

          <h3>4. Une pédagogie adaptée aux rythmes contemporains</h3>
          <p>Nos modules sont construits autour de capsules de 6 à 21 minutes, chacune centrée sur une question précise, un texte, un auteur, une notion ou un débat. Une grande attention est portée à la visualisation : frises chronologiques, cartes, schémas conceptuels, portraits, citations commentées. Il s'agit d'offrir un accès progressif et précis à des matières exigeantes, sans sacrifier la complexité.</p>

          <h2>Une plateforme au service d'un héritage intellectuel pluriel</h2>
          <p>L'objectif de Sijill Project n'est pas de promouvoir une école, une confession, une vision ou un cadre doctrinal particuliers. Nous ne cherchons ni à défendre une orthodoxie, ni à imposer une lecture, ni à simplifier les divergences. Ce que nous souhaitons, c'est mettre en lumière :</p>
          <ul>
            ...
            <li>l'articulation entre sciences religieuses, philosophiques et naturelles,</li>
